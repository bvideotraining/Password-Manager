  ...
  return (
    <>
      ...
      <div className="text-center text-sm mt-4 pt-4 border-t border-border/50">
        <a href="/api/extension/download" className="flex items-center justify-center gap-2 text-muted-foreground hover:text-emerald-500 transition-colors group">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
          <span>Download Chrome Extension</span>
          <span className="text-[10px] bg-emerald-500/10 text-emerald-500 px-1.5 py-0.5 rounded-full font-bold group-hover:bg-emerald-500/20">v1.1</span>
        </a>
      </div>
    </>
  )
